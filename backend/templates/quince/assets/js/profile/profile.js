    ...
    $(".input-file-custom").change(function () {
        ...
        if (input.files && input.files[0]) {
            ...
            reader.onload = function (e) {
                ...
                let fieldHTML = '<div class="remove_parent"><img class="uploading_img_from_brows" src="' + e.target.result + '"> <div class="remove_img_icon remove"></div> <div class="add_img_icon"></div>  </div>';
