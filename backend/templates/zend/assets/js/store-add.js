...
$(document).ready(function(){
    ...
    var fieldHTML = '<div><input class="form-control" type="text" name="field_name[]" value=""/><a href="javascript:void(0);" class="remove_button"><i class="fas fa-minus mt-2"></i></a></div>'; //New input field html 
    var x = 1;
